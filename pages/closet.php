...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
        ...
        <style>
           ...
           .image.selected {
            border: 5px solid #007bff; /* or any other color you prefer */
            }
        .shirts {
            display: grid;
...
<title>Form Submission</title>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#clothesForm').submit(function(event) {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        ...
                        $('#message').text('Error occurred during form submission.');
                    }
                });
            });
        });
...
<header>
            ...
            <div class="container  pt-4">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active-link fs-6" href="closet.php">Closet</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link  fs-6" href="outfits.php">Outfit Reccomendation</a>
                  </li>
                  <li class="nav-item">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-12">
                <ul class="nav nav-tabs underline-tabs mb-3">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#allTab">All</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#capsuleTab">Daily Fits</a>
                    </li>
                </ul>
                <div class="tab-content">
                    <!-- All Tab -->
                    <div class="tab-pane fade show active" id="allTab">
                        <button class="btn btn-danger fs-6 px-4 my-4"  id="add-button">Add clothes</button>
                        
                        <hr>
                       
                        <div class="weekly_capsules">
                        
                        <a href="laundry.php" class="btn btn-danger fs-6 px-4">Create fit</a>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                while ($data = mysqli_fetch_assoc($result)) {
                                    ...
                                    ?>
                                    <img src="<?php echo $imagePath; ?>" alt="Shirt">
                                    <?php
                                }
                                ?>
                                </div>         
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="skirts" id="skirts">
                                        <?php
                                            ...
                                            while ($data = mysqli_fetch_assoc($result)) {
                                                ?>
                                                <img src="images/<?php echo $data['image']; ?>" alt="Skirt">
                                                <?php
                                            }
                                        ?>
                                    </div>         
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="trousers" id="trousers">
                                        <?php
                                            ...
                                            while ($data = mysqli_fetch_assoc($result)) {
                                                ?>
                                                <img src="images/<?php echo $data['image']; ?>" alt="Trouser">
                                                <?php
                                            }
                                        ?>
                                 </div>         
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="suits" id="suits">
                                        <?php
                                            ...
                                            while ($data = mysqli_fetch_assoc($result)) {
                                                ?>
                                                <img src="images/<?php echo $data['image']; ?>" alt="Suit">
                                                <?php
                                            }
                                        ?>
                                 </div>        
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php
                                            ...
                                            while ($data = mysqli_fetch_assoc($result)) {
                                                ?>
                                                <img src="images/<?php echo $data['image']; ?>" alt="jacket">
                                                <?php
                                            }
                                        ?>
                                </div>
                    ...
                    <!-- Capsule Tab -->
                    <div class="tab-pane fade" id="capsuleTab">
                        <div id="capsuleContent">
                            <!-- Space for created capsules -->
                            <div id="weatherDiv" style="display: flex; align-items: center; margin-bottom: 20px;">
                            ...
                            <div>
                            <p>According to today's weather you can wear any from the recommended clothes below</p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4>Skirts</h4>
                                <div class="skirts" id="skirts">
                                    <!-- Display skirts content for capsule tab -->
                                    <?php
                                    if ($temperature > 28) {
                                        // Display summer shirts
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h4>Jackets</h4>
                                <div class="jackets" id="jackets">
                                    <!-- Display jackets content for capsule tab -->
                                    <?php
                                    if ($temperature > 28) {
                                        // Display summer shirts
   ...
   <form id="clothesForm" method="POST" class="clothesForm" enctype="multipart/form-data" action="upload_clothes.php">
    <input type="file" name="clothesImage" accept="image/*" required>
    ...
    <select name="description" required>
        ...
        <!-- Add more description options as needed -->
    </select>
    ...
    <button class="btn btn-danger" type="submit" onclick="showMessage()">Add</button>
    <div id="message"></div>
</form>
...
<section>
  ...
  $("[data-action='delete-clothes']").click(function() {
    var selectedImages = [];

    // Retrieve the selected images
    $(".shirts img.selected, .skirts img.selected, .trousers img.selected, .suits img.selected").each(function() {
    ...
    $.ajax({
        type: "POST",
        url: "deletepics.php",
        data: { selectedImages: selectedImages.join(',') },
        success: function(response) {
            console.log(response);
            // Handle the response from the server
        },
...
// Get the "Create Fit" button
const createCapsuleButton = document.getElementById('create_fit');

// Add a click event listener to the button
createCapsuleButton.addEventListener('click', function() {
  // Check if an image has been selected
  if (isImageSelected()) {
    // Redirect to the laundry.php page
...
function isImageSelected() {
  ...
  // Loop through the images and check if any of them have the 'selected' class
