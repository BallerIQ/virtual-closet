...
<header>
            ...
            <div class="container  pt-4">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link nav-link fs-6" href="outfits.php">Outfit Recommendation</a>
                  </li>
                  <li class="nav-item">
                    <button id="logout" class="btn btn-danger fs-6 px-4">Logout</button>
                  </li>
                </ul>
              </div>
            </div>
    ...
    <div id="notification" class="notification">
      <div class="notification-content">
        ...
        <p>You have dirty clothes, select your location <br>
          to see nearest laundry service providers</p>
        ...
        <div class="container">
             <div class="row">
                <div class="col-12">
                    ...
                    <label for="cities" style="font-weight: regular; font-size: 20px; color: grey;">Select a city for dry clean Services:</label>
                    <select id="cities" onchange="showCity()" style="margin-left: 10px;">
                    ...
                    <div id="city1" style="display: none; margin-top: 10px; font-weight: bold;">
                      <a href="https://jackslaundry.co.zw/">jackslaundry.co.zw/</a>
                    </div>

                    <div id="city2" style="display: none; margin-top: 10px; font-weight: bold;">
                      <a href="https://www.brabys.com/zw/gweru/dry-cleaners">https://www.brabys.com/zw/gweru/dry-cleaners</a>
                    </div>

                    <div id="city3" style="display: none; margin-top: 10px; font-weight: bold;">
                      <a href="https://tracks4africa.co.za/listings/item/w626240/marjoh-dry-cleaning-and-launderette/">https://tracks4africa.co.za/listings/item/w626240/marjoh-dry-cleaning-and-launderette/</a>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="col-md-12 mt-4 mb-4">
                            <h5>These clothes need to be cleaned</h5>
    ...
    <script>
        function showCity() {
            ...
            // Show the corresponding city text based on the selected option
